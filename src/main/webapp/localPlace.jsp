...
<head>
	...
	<title>Local Place - Tour Guide</title>
...
<body>
	...
	<%
		...
		String sql = "select * from locallistings where listingID="+listID+"";
    ...
    <div class="house-title">
        ...
        <div class="row">
            ...
            <div>
                <p><%=rs.getString("location")%>, <%=rs.getString("province")%>, <%=rs.getString("country")%></p>
            </div>
        </div>
    </div>
    
    <div class="gallery">
        <div class="gallery-img-1"><img src="./images/localPlaces/<%=rs.getString("imageFileName1")%>" alt=""></div>
        <div><img src="./images/localPlaces/<%=rs.getString("imageFileName2")%>" alt=""></div>
        <div><img src="./images/localPlaces/<%=rs.getString("imageFileName3")%>" alt=""></div>
        <div><img src="./images/localPlaces/<%=rs.getString("imageFileName4")%>" alt=""></div>
        <div><img src="./images/localPlaces/<%=rs.getString("imageFileName5")%>" alt=""></div>
    </div>
    ...
    <div class="lz">
        ...
        <div class="bform right">
            ...
            <form action="#" method="get">
                <label>No of Adults: </label> <input type="text" placeholder="ages 18 or above" id="adult" onchange="calculateAmount()">
                <label>No of Children: (half of price)</label> <input type="text" placeholder="ages 4-17" id="child" onchange="calculateAmount()">
                <label>Price: </label> <input type="text" id='totalPrice' readonly>
    ...
    <div class="map">
        ...
        <b><%=rs.getString("location")%>, <%=rs.getString("province")%>, <%=rs.getString("country")%></b>
